...
sudo apt-get update && apt-get upgrade -y && apt-get install lsb-release nscd curl nano php5.6 php5.6-mysql php5.6-cli php5.6-curl unzip screen build-essential -y && apt-get install php5.6-mcrypt
